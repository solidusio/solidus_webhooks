...
Gem::Specification.new do |spec|
  ...
  spec.homepage = 'https://github.com/nebulab/solidus_webhooks#readme'
  spec.license = 'BSD-3-Clause'

  spec.metadata['homepage_uri'] = spec.homepage
  spec.metadata['source_code_uri'] = 'https://github.com/nebulab/solidus_webhooks'
  spec.metadata['changelog_uri'] = 'https://github.com/nebulab/solidus_webhooks/releases'
